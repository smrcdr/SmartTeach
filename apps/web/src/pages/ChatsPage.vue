  ...
  <main class="dashboard-layout chat-page-shell">
    <section class="dashboard-main chat-page-main">
      <section class="chat-layout">
        <aside class="chat-sidebar" :class="{ 'mobile-chat-hidden': mobileChatOpen }">
        ...
        <section v-if="selectedChat" class="chat-window" :class="{ 'mobile-chat-open': mobileChatOpen }">
          <header class="chat-window-header">
            <div class="chat-window-profile">
              <button type="button" class="chat-back-btn" aria-label="Назад к списку чатов" @click="closeMobileChat">
